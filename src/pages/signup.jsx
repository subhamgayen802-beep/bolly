      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-1/2 relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 text-white max-w-md text-center">
          ...
          <p className="text-white/80 text-lg leading-relaxed">
            Join thousands who have discovered<br/>the secret to flake-free, radiant hair.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[55%] xl:w-1/2 flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm mt-2">Join the Bolly family today</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              <label className="flex items-start gap-3 text-sm text-gray-600 cursor-pointer select-none">
                <input 
                  type="checkbox" 
                  className="w-4 h-4 mt-0.5 rounded-lg border-gray-300 text-purple-600 focus:ring-purple-500 cursor-pointer"
                  {...register('terms')}
                />
                <span className="text-xs leading-relaxed">
                  I agree to the <NavLink to="/terms" className="text-purple-600 font-bold hover:underline">Terms of Service</NavLink> and <NavLink to="/privacy" className="text-purple-600 font-bold hover:underline">Privacy Policy</NavLink>
                </span>
              </label>
              {errors.terms && (
                <p className="mt-1.5 text-sm text-red-500 font-medium">{errors.terms.message}</p>
              )}
            </div>
          ...
          <div className="flex items-center my-8">
            ...
            <span className="px-4 text-gray-400 text-xs font-bold uppercase tracking-widest">or sign up with</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
          ...
          <p className="text-center text-sm text-gray-600">
            ...
            <NavLink to="/signin" className="text-purple-600 hover:text-purple-800 font-bold transition-colors">
              Sign In
            </NavLink>
          </p>
        </div>
